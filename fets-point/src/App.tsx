...
const FetsRoster = lazy(() => import('./components/FetsRosterPremium').then(module => ({ default: module.FetsRosterPremium })))
...
const PremiumShowcase = lazy(() => import('./components/PremiumShowcase').then(module => ({ default: module.default })))
