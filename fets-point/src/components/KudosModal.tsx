...
import { z } from 'zod';
import { kudosSchema } from '../lib/validators';
...
const KudosModal = ({
  ...
  const handleSubmit = async () => {
    try {
      const validatedData = kudosSchema.parse({ receiver_id: receiverId, message });
      ...
      if (error instanceof z.ZodError) {
        ...
        toast.error('Failed to give kudos. Please try again.');
      }
    } finally {
