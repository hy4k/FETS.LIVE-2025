// Bump versions to force update after deploy
const CACHE_NAME = 'fets-point-v2.2';
const STATIC_CACHE = 'fets-point-static-v2.2';
const DYNAMIC_CACHE = 'fets-point-dynamic-v2.2';
const API_CACHE = 'fets-point-api-v2.2';
const IMAGES_CACHE = 'fets-point-images-v2.2';
...
self.addEventListener('install', (event) => {
  log('Installing Service Worker v2.1...');
...
self.addEventListener('activate', (event) => {
  log('Activating Service Worker v2.1...');
...
log('🚀 FETS Point Service Worker v2.1 loaded successfully');
