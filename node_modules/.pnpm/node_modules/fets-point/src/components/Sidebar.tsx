...
const navigationGroups = {
  ...
  admin: [
    { id: 'staff-management', name: 'User Management', icon: UsersRound, role: ['super_admin', 'admin'] },
    { id: 'news-manager', name: 'News Manager', icon: Megaphone, role: ['super_admin'] },
    { id: 'premium-showcase', name: 'Premium Showcase', icon: Sparkles, badge: 'NEW' },
...
export function Sidebar({ 
  ...
  const sidebarClassName = `reference-glassmorphic-sidebar ${
    isMobile ? 'w-96' : isCollapsed ? 'w-24' : 'w-80'
  }`
            ...
            <div className="reference-brand-logo group">
              <div className="relative">
                ...
                <img
                  ...
                  alt="FETS.LIVE"
                  className="h-24 w-auto object-contain relative z-10 drop-shadow-2xl group-hover:scale-105 transition-transform duration-300"
                  style={{ filter: 'drop-shadow(0 8px 24px rgba(245, 158, 11, 0.4))' }}
                />
              </div>
            </div>
            <h2 className="reference-brand-title" style={{
              fontSize: '1.75rem',
              fontWeight: '900',
