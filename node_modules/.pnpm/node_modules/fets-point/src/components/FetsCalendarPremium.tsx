...
export function FetsCalendarPremium() {
  ...
  return (
    <div className="page-wrapper--fets-calendar min-h-screen">
      ...
      <div className="relative border-b border-rose-100 bg-gradient-to-r from-rose-500 via-rose-600 to-pink-600">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between space-y-8 lg:space-y-0">
            ...
            <div className="text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start mb-4">
                <div className="relative p-3 bg-white/20 backdrop-blur rounded-xl border border-white/30">
                  <Calendar className="h-7 w-7 text-white" />
                </div>
                <div className="ml-4">
                  <h1 className="text-h2 font-bold text-white tracking-tight">FETS Calendar</h1>
                  <p className="text-rose-100 text-sm font-medium">Session planning and overview</p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-center lg:justify-start">
                <div className="bg-white/20 backdrop-blur rounded-full px-4 py-2 border border-white/30">
                  <div className="flex items-center space-x-3 text-sm">
                    <span className="inline-block w-2 h-2 bg-rose-200 rounded-full" />
                    <span className="text-white font-semibold">
                      {activeBranch === 'calicut' ? 'Calicut Centre' :
                       activeBranch === 'cochin' ? 'Cochin Centre' : 'Global View'}
                    </span>
                    <span className="text-white/70">•</span>
                    <span className="text-rose-100">{monthYear}</span>
                  </div>
                </div>
              </div>
            </div>
